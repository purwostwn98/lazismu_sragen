...
$latestBadan  = $latestBadan ?? ($riwayatBadan[0] ?? null);
...
<div class="card mb-4">
  <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-3">
    <div class="d-flex align-items-center gap-3">
      <div class="avatar avatar-lg flex-shrink-0">
        <span class="avatar-initial rounded bg-label-<?= $statusColor ?>">
          <i class="icon-base ti tabler-gavel icon-lg"></i>
        </span>
      </div>
      <div>
    ...
    <a href="<?= base_url('disposisi/badan-pengurus') ?>" class="btn btn-label-secondary btn-sm">
...
<?= view('disposisi/_hasil_card', ['judul' => 'Hasil Tinjauan Manager', 'data' => $manager]) ?>

<?= view('disposisi/_form_tinjauan', [
  'latest'      => $latestBadan,
  'actionUrl'   => base_url('disposisi/badan-pengurus/' . $ajuan['nomor_ajuan'] . '/store'),
  'judulForm'   => 'Formulir Tinjauan Badan Pengurus',
  'judulSudah'  => 'Tinjauan Badan Pengurus sudah diisi',
  'placeholder' => 'Tuliskan hasil tinjauan atas ajuan dan hasil tinjauan tahap-tahap sebelumnya di atas...',
]) ?>

<?= view('disposisi/_riwayat_tinjauan', ['judul' => 'Riwayat Tinjauan Badan Pengurus', 'riwayat' => $riwayatBadan]) ?>
