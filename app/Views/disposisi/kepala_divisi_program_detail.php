...
<div class="card mb-4">
  <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-3">
    ...
    <a href="<?= base_url('disposisi/kepala-divisi-program') ?>" class="btn btn-label-secondary btn-sm">
...
<?= view('disposisi/_form_tinjauan', [
  'latest'      => $latestKadiv,
  'actionUrl'   => base_url('disposisi/kepala-divisi-program/' . $ajuan['nomor_ajuan'] . '/store'),
  'judulForm'   => 'Formulir Tinjauan Kepala Divisi Program',
  'judulSudah'  => 'Tinjauan Kepala Divisi Program sudah diisi',
  'placeholder' => 'Tuliskan hasil tinjauan atas ajuan dan hasil survey di atas...',
]) ?>

<?= view('disposisi/_riwayat_tinjauan', ['judul' => 'Riwayat Tinjauan Kepala Divisi Program', 'riwayat' => $riwayatKadiv]) ?>
