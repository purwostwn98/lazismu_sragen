...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
  <div>
    <h4 class="mb-1"><?= esc($title ?? 'Ajuan Internal') ?></h4>
    <p class="text-body-secondary mb-0">Total <?= count($rows) ?> ajuan diajukan oleh pihak internal.</p>
  </div>
...
<div class="card">
  <div class="table-responsive">
    <table class="table table-hover table-sm datatable w-100">
      ...
      <tbody>
        <?= view('ajuan/_rows', ['rows' => $rows, 'from' => 'internal']) ?>
      </tbody>
    </table>
  </div>
</div>
